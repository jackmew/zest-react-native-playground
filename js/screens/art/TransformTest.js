...
export default class TransformTest extends Component {
    ...
    render() {
        ...
        let RING_TWO_ROTATE = new Transform().translate(84.000000, 89.000000).rotate(-240.000000).translate(-84.000000, -89.000000);
